...
const Home = {
    ...
    methods: {
        ...
        cartRemoveItem(id) {
            this.$delete(this.cart, id);     //Pour enlever un élément du DOM, c'est du vu $delete
        },
...
const UserSettings = {
    ...
    name: 'UserSettings'     //Le nom du component
}
const WishList = {
    template: '<h1>WishList</h1>',
    name: 'WishList'     //Le nom du component
}


const ShoppingCart = {
    template: '<h1>ShoppingCart</h1>',
    name: 'ShoppingCart'     //Le nom du component
}
